...
<Frame>
  <img src="/images/nodo-flujo-placeholder.png" alt="Ejemplo de flujo conversacional con nodo de flujo ejecutando un workflow" />
</Frame>

Los nodos de flujo se pueden usar de dos formas según su posición en el camino:

- **Durante la llamada**: cuando se colocan en el flujo regular de la conversación, actúan como nodos de herramienta pero ejecutan un flujo completo en lugar de una sola llamada a la API. El flujo asignado debe usar el trigger **Llamada a función**.
- **Post-llamada**: cuando se conectan después de un nodo de Terminar, se ejecutan automáticamente una vez que la llamada finaliza. El flujo asignado debe usar el trigger **Llamada finalizada**.
