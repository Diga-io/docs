...
description: "Guía completa de los seis tipos de nodos disponibles en caminos conversacionales y cuándo usar cada uno"
---
...
<Frame>
  <img src="/images/nodo-inicio.png" alt="Ejemplo de flujo conversacional con nodo de inicio" style={{ maxWidth: "60%" }}/>
</Frame>
...
<Frame>
  <img src="/images/nodo-pre-llamada-placeholder.png" alt="Nodo de flujos pre-llamada encima del nodo de inicio" style={{ maxWidth: "60%" }} />
</Frame>
...
<Frame>
  <img src="/images/nodo-conversacion.png" alt="Ejemplo de flujo conversacional con varios nodos de conversación" style={{ maxWidth: "60%" }}/>
</Frame>
### Instrucciones
...
Los nodos de conversación pueden acceder a bases de conocimiento específicas para que el agente consulte información relevante en este nodo. Al seleccionar **Conocimiento contextual**, el agente puede apoyarse en las fuentes elegidas para mejorar la relevancia de sus respuestas en este punto de la conversación.
...
<Frame>
  <img src="/images/nodo-herramienta.png" alt="Ejemplo de flujo conversacional con nodo de herramienta para llamar a una API externa" style={{ maxWidth: "60%" }}/>
</Frame>
### Características
...
<Frame>
  <img src="/images/nodo-flujo-placeholder.png" alt="Ejemplo de flujo conversacional con nodo de flujo ejecutando un workflow" style={{ maxWidth: "60%" }}/>
</Frame>
...
<Frame>
  <img src="/images/nodo-terminar.png" alt="Ejemplo de flujo conversacional con nodo de terminación después de un nodo de conversación" style={{ maxWidth: "60%" }}/>
</Frame>