...
A continuación se describen los pasos para asignar una integración existente a un agente en modo prompt único. Si quieres añadir integraciones a un agente de Camino Conversacional, consulta la sección correspondiente sobre los [nodos de herramienta](/es/build/agentes/camino-conversacional/tipos-nodos)
...
<Steps>
  ...
  <Step title="Ve a Integraciones">
    En la configuración del agente que aparece en el menú lateral, abre la pestaña **Herramientas** y busca la sección **Integraciones**. (Esta sección está disponible para agentes de prompt único.)
  </Step>

  <Step title="Añade Integración">
    Abre el dropdown **Añadir Integración** y selecciona la integración que quieres asignar.

    Se mostrarán todas las integraciones disponibles en tu proyecto. Si todavía no tienes ninguna integración, esta acción te lleva a la página de [Integraciones](/es/build/integraciones/integraciones-http) para crear una — las integraciones no se crean directamente desde este menú.
  </Step>
...
<Frame>
  <img src="/images/asignar-integration-agente.png" alt="Pantalla de asignación de integración a un agente mostrando la selección de herramientas" />
</Frame>
