...
<Note>
**Recomendación:** Usa valores de tipo string (texto) en `dynamic_variables`. Otros tipos de datos como números o booleanos se aceptan, pero sus valores se convierten a texto al insertarse en los prompts y condiciones, por lo que usar strings mantiene el resultado predecible.
</Note>
...
```text
Eres un asistente de {{nombre_negocio}} llamando para confirmar una cita.
...
Confirma que el cliente puede asistir y recuérdale llegar 15 minutos antes.
```
