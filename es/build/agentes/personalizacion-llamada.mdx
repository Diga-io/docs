...
## Ajustes de llamada
Controla el comportamiento del agente durante la llamada, incluyendo el sonido ambiente, la gestión de silencios y la detección de buzones de voz y menús telefónicos.
...
- **Detección de buzón de voz**. El agente detecta cuando la llamada la responde un buzón de voz y actúa según tu configuración: dejar un mensaje personalizado o colgar directamente.
- **Detección de menú telefónico (IVR)**. El agente detecta cuando responde un sistema automático de opciones (IVR) y puede navegar por el menú para llegar a la persona o departamento adecuado.
