...
- **Voz** del agente. Selecciona la voz que utilizará el agente al hablar. La voz define el **timbre y el estilo de comunicación** durante la llamada. Al hacer clic en el selector de voz, se abre un modal con el catálogo completo de voces de **ElevenLabs**, donde puedes:
  - **Filtrar** voces por género, idioma y acento.
  - **Buscar** voces por ID.
  - **Previsualizar** cada voz antes de seleccionarla.
  - **Guardar voces en favoritos** para acceder rápidamente a las que más usas.

<Frame>
  <img src="/images/voces-agente.png" alt="Voces del agente" />
</Frame>

  Una vez seleccionada la voz, puedes ajustar los siguientes parámetros:
  - **Velocidad de la voz**: controla qué tan rápido habla el agente (valor por defecto: x1).
  - **Volumen de la voz**: ajusta el nivel de volumen de la voz (valor por defecto: 0,5).
  - **Temperatura de la voz**: regula la variabilidad y naturalidad de la voz. Valores más altos generan un habla más expresiva y variada, mientras que valores más bajos producen un tono más consistente y predecible (valor por defecto: 0,5).
...
## Ajustes de llamada
Controla el comportamiento del agente durante la llamada, incluyendo sonido ambiente y gestión de silencios.
