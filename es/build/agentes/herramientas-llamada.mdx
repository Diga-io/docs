...
<AccordionGroup>
  <Accordion title="Llamadas salientes automatizadas">
    ...
    **Ejemplo de configuración:**
    ...
    "Hola, habla [Nombre] de [Empresa]. Te llamamos para [motivo].
    Por favor llámanos al [número]. Gracias."
    ```
  </Accordion>
...
<CardGroup cols={2}>
  ...
  >
    Aprende a crear integraciones personalizadas
  </Card>
  ...
  >
    Ajusta voz, velocidad e idioma de tu agente
  </Card>
</CardGroup>
