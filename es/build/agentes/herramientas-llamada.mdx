...
Actualmente hay dos herramientas de llamada que puedes habilitar en tus agentes:
...
## ¿Buscas la detección de contestador?

La antigua herramienta **Detección de contestador** se ha sustituido por una configuración más completa en **Personalización → Ajustes de llamada**: detección de buzones con mensaje personalizable y navegación automática de menús telefónicos. Los agentes que tenían la herramienta asignada se migraron automáticamente.

Aprende más en [Detección de buzón y menús telefónicos](/es/build/agentes/deteccion-buzon-menu-telefonico).
