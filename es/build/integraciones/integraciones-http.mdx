...
<Steps>
  ...
  <Step title="Define Parámetros">
    ...
    **Parametros del body**: Se envían en el cuerpo de la solicitud (JSON)
    ...
    - **Tipo de Dato**: string, integer, number, boolean. Los parámetros del body pueden ser además **object** (con propiedades anidadas).
    ...
    - **Modo de obtención**: Cómo el agente consigue este valor:
      ...
      - Valor dinámico: valor rellenado en tiempo de ejecución desde una plantilla/variable.
...
<Note>
  Las herramientas reciben el mismo tratamiento integrado que los flujos cuando el llamante interrumpe una herramienta en ejecución o la petición falla a mitad de llamada: la ejecución nunca se cancela, el agente recibe el resultado real y nunca afirma un resultado que no puede confirmar. Consulta [Cuando el llamante interrumpe un flujo en ejecución](/es/build/flujos/flujos-durante-llamada#cuando-el-llamante-interrumpe-un-flujo-en-ejecución).
</Note>
