...
<Frame>
  <img src="/images/add-bases.png" alt="Bases de conocimiento" />
</Frame>
...
<Steps>
  ...
  <Frame>
  <img src="/images/modal-añadir-URL.png" alt="Modal añadir URL" />
</Frame>
  </Step>
  <Step title="Guarda">
...
<Steps>
  ...
  <Frame>
  <img src="/images/mover-bases.png" alt="Modal mover bases de conocimiento" />
</Frame>
  </Step>
...
El almacenamiento total disponible para bases de conocimiento (RAG Storage) depende de tu plan de suscripción. Consulta la página de [Planes y precios](/es/plataforma/facturacion) para ver los límites de tu plan, y [Ajustes > Uso](/es/plataforma/uso#bases-de-conocimiento) para ver el espacio que llevas ocupado.
