...
Si prefieres verlo en vídeo, este tutorial recorre la creación de un flujo completo: trigger, parámetros, acciones, publicación, habilitación y asignación al agente.

<Frame>
  <iframe
    className="w-full aspect-video rounded-xl"
    src="https://www.youtube.com/embed/O2w0x3xtzMo"
    title="Flujos | Tutoriales Diga"
...
<AccordionGroup>
  <Accordion title="Condiciones (Router)">
