...
<Note>
Los nombres de los spans que se muestran en la interfaz de trazas provienen de la instrumentación subyacente, por lo que pueden diferir ligeramente de los nombres descriptivos de esta tabla. Las trazas también dependen de la disponibilidad del almacenamiento de trazas y pueden no aparecer si este no está disponible temporalmente.
</Note>
