...
<AccordionGroup>
  ...
  <Accordion title="¿Puedo editar los permisos de una clave existente?">
    Sí. Puedes editar el nombre y los permisos de una clave en cualquier momento desde la tabla de claves. El valor secreto de la clave nunca cambia y no se vuelve a mostrar, por lo que actualizar los permisos no requiere regenerar la clave.
  </Accordion>
