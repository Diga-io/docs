...
If you prefer video, this tutorial shows how to build an agent from a prompt: prompt, voice, language, call settings, knowledge bases, tools, and publishing. The video is in Spanish.
...
<Steps>
    ...
    <Step title="Enter the agent's basic information">
        1. Choose between "Unique prompt" or "Conversational path".
    ...
    <Step title="Customize the agent's behavior">
        ...
        2. Adjust additional settings like voice, language, and volume.
        <Frame>
