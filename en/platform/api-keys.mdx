...
<Frame>
  <img src="/images/create-apikey.png" alt="Restrict permissions" />
</Frame>
...
<AccordionGroup>
  ...
  <Accordion title="Can I edit the permissions of an existing key?">
    Yes. You can edit a key's name and permissions at any time from the keys table. The key's secret value never changes and is never shown again, so updating permissions doesn't require regenerating the key.
  </Accordion>
