...
Each plan differs in these features:

- **Included minutes** per month
- **Price per extra minute**, once the included ones are used up
- **Concurrent calls** allowed
- **[Use of Melo](/en/platform/melo)**, your weekly AI assistant quota
- **RAG Storage**, the space for your agents' [knowledge bases](/en/build/knowledge-bases)
- **Flows** you can keep published
- **Support** included

<Info>
Included minutes are allocated **monthly**, on both monthly and annual billing.
</Info>

<Note>
Check the exact figures for each plan on the [pricing page](https://www.diga.io/pricing), where they're always up to date. To see how much of your plan limits you've used, go to [Settings > Usage](/en/platform/usage).
</Note>
...
- They're only charged if you have [usage-based billing](/en/platform/usage#usage-based-billing) enabled and go beyond your plan's included minutes.
- They're billed monthly, alongside the rest of the period's charges.
...
<AccordionGroup>
  ...
  <Accordion title="What if I need more minutes but don't want to change plans?">
    You can enable **usage-based billing** from [Settings > Usage](/en/platform/usage). Extra minutes will be billed monthly.
  </Accordion>
</AccordionGroup>
