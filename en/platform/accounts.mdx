---
title: User Account
description: "Manage your Diga account: personal profile, security settings, and your memberships across every project — all from one place."
---
...
<Steps>
  ...
  <Step title="Update your information">
    Modify your name, last name, or other personal information. From here you can also:

    - **Language**: change the language of the dashboard interface.
    - **Password**: set or change your password. If you signed up with an external provider (OAuth), you'll see a **Set password** option; otherwise you'll see **Change password**. Passwords must be at least **8 characters** and include a **special character**.
  </Step>
