...
<Frame>
  <img src="/images/conversational-flow-tool-node.png" alt="Conversational flow example with tool node to check availability" />
</Frame>
...
<Frame>
  <img src="/images/conversational-flow-transfer-node.png" alt="Conversational flow example with transfer node to human agent" />
</Frame>
...
<Frame>
  <img src="/images/conversational-flow-end-node.png" alt="Conversational flow example with end node after a conversation node" />
</Frame>
