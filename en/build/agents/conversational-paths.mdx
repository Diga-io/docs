...
This video shows how to build an agent with conversational paths: nodes, transitions, tool and flow nodes, transfers, and global nodes. The video is in Spanish.

<Frame>
  <iframe
    className="w-full aspect-video rounded-xl"
    src="https://www.youtube.com/embed/sLuhV0bVzGc"
    title="Agentes avanzados con caminos conversacionales | Tutoriales Diga"
...
<Frame>
  <img src="/images/ejemplo-camino.png" alt="Conversational flow diagram showing nodes connected with transition conditions" />
</Frame>
