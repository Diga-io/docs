...
<Frame>
    <img src="/images/agent-call-settings-detection.png" alt="Call settings section showing the voicemail detection and phone menu detection toggles, with navigation by goal selected" />
</Frame>
