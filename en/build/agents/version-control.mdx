...
1. Click the "Create version" button in the editor
...
On the draft, the primary button is "Create version". To publish your current draft, create the version and enable the **Publish immediately** checkbox:

1. Make sure the draft has the changes you want
2. Click "Create version"
3. Optionally, add a descriptive name
4. Enable the **Publish immediately** checkbox
5. Assign the phone number that will use this agent (incoming and/or outgoing)
6. Confirm

**Option 2: Publish a saved version**

The standalone "Publish" button only appears on saved (non-draft) versions:

1. Go to version history
2. Find the version you want to publish
3. Click "Publish" next to that version
4. Assign the phone number that will use this agent (incoming and/or outgoing)
5. Confirm
