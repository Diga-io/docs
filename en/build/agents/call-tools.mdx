---
title: "Call Tools"
description: "Built-in call tools let your Diga voice agent transfer, end, and control phone calls in real time during a conversation — no external integration needed."
---
...
<CardGroup cols={2}>
  ...
  >
    Adjust voice, volume, and language for your agent
  </Card>
</CardGroup>
