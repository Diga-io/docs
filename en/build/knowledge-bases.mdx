...
<Frame>
  <img src="/images/add-bases.png" alt="Knowledge bases" />
</Frame>
...
The total storage available for knowledge bases (RAG Storage) depends on your subscription plan. See the [Plans and Pricing](/en/platform/billing) page for your plan's limits, and [Settings > Usage](/en/platform/usage#knowledge-bases) to see how much space you're currently using.
