...
<Warning>
  Remember that after copying a template you need to **publish** and then **enable** the workflow. You also need to [assign the workflow to an agent](/en/build/flows/assign-agents) if it uses Diga triggers (Pre-Call, Call Finished, or Function Call).
</Warning>
