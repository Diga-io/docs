...
- **The agent acknowledges what already happened.** If the caller changed their mind mid-execution, the agent says out loud what was already done before adjusting, instead of pretending nothing happened or running the flow twice.
