...
If you prefer video, this tutorial walks through building a complete flow: trigger, parameters, actions, publishing, enabling, and assigning it to the agent. The video is in Spanish.
